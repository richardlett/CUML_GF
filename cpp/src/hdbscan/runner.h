 ...
 */
template <typename value_idx = int64_t, typename value_t = float>
void build_linkage_GF(const raft::handle_t& handle,
                   const value_t* X1,
                  const value_t* X2,
                   size_t m,
                   size_t n1,
                   ...
                   Common::robust_single_linkage_output<value_idx, value_t>& out)
{
  ...
  detail::Reachability::mutual_reachability_graph_GF(handle,
                                                  X1,
                                                  X2,
                                                  (size_t)m,
                                                  (size_t)n1,
  ...
  FixConnectivitiesRedOp<value_idx, value_t> red_op(color.data(), core_dists, m);
  // during knn graph connection
  raft::cluster::detail::build_sorted_mst_GF(handle,
                                          X1,
                                          X2,
                                          mutual_reachability_indptr.data(),
                                          mutual_reachability_coo.cols(),
...
template <typename value_idx = int64_t, typename value_t = float>
void _fit_hdbscan_GF(const raft::handle_t& handle,
                  const value_t* X1,
                  const value_t* X2,
                  size_t m,
                  size_t n1,
